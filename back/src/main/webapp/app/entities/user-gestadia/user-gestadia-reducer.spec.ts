...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERGESTADIA_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERGESTADIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERGESTADIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERGESTADIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERGESTADIA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERGESTADIA actions', async () => {
      const expectedActions = [
        {
