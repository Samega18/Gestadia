package com.milos.gestadia.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.milos.gestadia.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.milos.gestadia.security.DomainUserDetailsService", "createSpringSecurityUser");
