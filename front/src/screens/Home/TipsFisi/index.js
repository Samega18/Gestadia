...
function TipsFisi(){
    ...
    return(
        <View style={[styles.container, {backgroundColor: colorSecundary}]}>
            <View style={styles.tipsFisiTop}>
                <IconFW name={'arrow-back'} size={42} color={'black'} onPress={() => navigation.goBack()}/>
            </View>
            <ScrollView style={styles.scrollContainer}>
                <View style={styles.tipsFisiMid}>
                    <Text style={styles.midText}>Dicas de Atividades Fisicas</Text>
                </View>
                <View style={styles.tipsFisiOptionsContainer}>
