...
function Notifications(){
    ...
    return(
        <View style={[styles.container, {backgroundColor: colorSecundary}]}>
            ...
            <View style={styles.notificationsMid}>
                <Text style={styles.midText}>Notificações</Text>
            </View>
            <View style={styles.notificationsOptionsContainer}>
                <Option label={'Nova atividade Disponivel'}/>
                <Option label={'Novas dicas de alimentos disponiveis '}/>
            </View>
        </View>
    )
}
