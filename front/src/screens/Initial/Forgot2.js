...
const Forgot2Screen = ({ navigation }) => {
    ...
    <KeyboardAvoidingView behavior="height" style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <View style={styles.inputContainer}>
            <Text style={styles.label}>Insira o código recebido</Text>
            <TextInput
            style={styles.input}
            placeholder="Código"
        ...
        <View style={styles.buttonsContainer}>
            <TouchableOpacity style={styles.buttonContainerB} onPress={() => navigation.navigate('Forgot')}>
